...
cd "%PS3_TOOL%\"
scetool.exe --sce-type=SELF %SELF_ARGS% --skip-sections=FALSE --key-revision=1c --self-auth-id=1010000001000003 --self-vendor-id=01000002 --self-app-version=0001000000000000 --encrypt "%DIR_BUILD%\EBOOT.ELF" "%DIR_OUTPUT%\PS3_GAME\USRDIR\EBOOT.BIN" >"%DIR_BUILD%\log.txt"
