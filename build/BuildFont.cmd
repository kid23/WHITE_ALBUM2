...
rem python font_tool.py -mup "%DIR_TEMP%\txtchs" "%DIR_TEMP%\font\up.txt"
"%WORK_SPACE%\binary\FontMake.exe" -fwa2 "%DIR_TEMP%\font\final2.txt" "%DIR_TEMP%\font\up.txt" "%DIR_TEMP%\font\final2.txt" 
copy "%DIR_TEMP%\data.dar_unpacked\ddspkg\02309.pkgdds" "%DIR_TEMP%\font"
move font1.png "%DIR_TEMP%\font\02309.pkgdds_000.png"
rem move font2.png "%DIR_TEMP%\font\02309.pkgdds_001.png"
...
rem "%PS3_TOOL%\dds2gtf.exe" "%DIR_TEMP%\font\02309.pkgdds_001.dds"
